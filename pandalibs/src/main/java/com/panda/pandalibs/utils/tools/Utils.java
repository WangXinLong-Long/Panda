package com.panda.pandalibs.utils.tools;
...
import com.panda.pandalibs.utils.cache.OtherDataProvider;
import com.panda.pandalibs.utils.cache.SPreference;
...
import static com.panda.pandalibs.utils.constant.RxConstant.IM_FINISH_NO_RESUME_OBSERVABLE;
...
public class Utils {
    ...
    public static void toLogin() {
        if (!OtherDataProvider.findTopActivity(App.getContext()).contains("LoginActivity")) {
    ...
    public static void killHightProcess() {
        ActivityManager appAM = (ActivityManager) App.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static String handlerPromptContent(String s){
        if(!TextUtils.isEmpty(s)){
            if (s.contains("failed to connect to") || s.contains("502") || s.contains("404") || s.contains("failed to connect to")
                ...
                s ="网络连接超时";// App.getContext().getString("");
        }
        return s;
    }
}
