...
public class DBOpenHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "ThingsFreeDb.db"; //数据库名称
    private static final int DATABASE_VERSION = 2;//数据库版本
    public static final String TABLE_NAME_USER = "tfdb_user";
    public static final String TABLE_NAME_OTHER = "tfdb_other";
